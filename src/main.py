...
if __name__ == '__main__':
    ...
    files_to_download_1 = [file for file in esol_bucket.objects.all()
    ...
    files_to_download_2 = [file for file in esol_bucket.objects.all() if file.key in input_fileset]

    files_to_download = files_to_download_1 + files_to_download_2

    max_timestamp_this_run = [{"max_timestamp_this_run": max(file.last_modified
                                                             for file in files_to_download).replace(
